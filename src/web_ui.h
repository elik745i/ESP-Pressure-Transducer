...
<body>
      ...
      <section class="panel panel-wide">
        ...
        <div id="tab-oled" class="tab-panel" role="tabpanel">
          ...
          <form id="oledForm">
            ...
            <p class="note">Current layout is fixed to top IP, large center pressure in bar, and MQTT status on the bottom line.</p>
          </form>
        </div>
  ...
  <script>
    const fields = [
      ...
      "publishIntervalSeconds", "oledContrast"
    ];
    ...
    function readForm() {
      ...
      ["sensorMinVoltage", "sensorMaxVoltage", "sensorMaxPressureKPa", "buzzerAlarmThresholdKPa", "oledContrast"].forEach((id) => {
        payload[id] = Number(payload[id]);
      });
      checkboxes.forEach((id) => {
